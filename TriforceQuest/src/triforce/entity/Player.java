...
public class Player extends GameMovable implements GameEntity, Drawable, Overlappable, Unit, KeyListener{
	...
	public Player(Canvas defaultCanvas, String spritePath, PlayerObserver observer, int x, int y, int strikeKey) {
		spriteManager = new PlayerSpriteManagerImpl(spritePath,
